    ...
    while True:
        ...
        try:
            ...
            if "jarvis" in command:
                ...
                if course_data:
                    if "document" in command or "documents" in command and any(
                            "pdeu college" or "pdpu college" or course in command for course, _ in cutoff_data):
                        ...
                        scrape_comparison(url_comparison_computer, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        ...
                        scrape_comparison(url_comparison_ICT, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        response_text = f"Comparison data has been downloaded for {command} as a Word and PDF file."
                        ...
                        scrape_comparison(url_comparison_mechanical, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        response_text = f"Comparison data has been downloaded for {command} as a Word and PDF file."
                        ...
                        scrape_comparison(url_comparison_chemical, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        response_text = f"Comparison data has been downloaded for {command} as a Word and PDF file."
                        ...
                        scrape_comparison(url_comparison_civil, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        response_text = f"Comparison data has been downloaded for {command} as a Word and PDF file."
                        ...
                        scrape_comparison(url_comparison_electrical, class_name, output_comparison_word_file,
                                          output_comparison_pdf_file)
                        response_text = f"Comparison data has been downloaded for {command} as a Word and PDF file."

                    # Check if the user's command contains "fees" and a course name
                    elif "fees" in command or "fee" in command and any(
                            course in command for course, _, _ in course_data):
                    ...
                    elif "cutoff" in command or "cut off" in command and any(
                            course in command for course, _ in cutoff_data):
                        # Extract the course name from the command
                    ...
                    elif "ranking" in command and any(
                            "pdeu college" or "pdpu college" or course in command for course, _ in cutoff_data):
                        if ranking_text:
